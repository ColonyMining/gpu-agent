  ...
  return {
    ...
    core: function (gpuIndex, value) {
      commands.push({
        ...
        execute: `nvidia-settings -c ${display} -a [gpu:${gpuIndex}]/GPUGraphicsClockOffset[2]=${value}`,
    ...
    memory: function (gpuIndex, value) {
      commands.push({
        ...
        execute: `nvidia-settings -c ${display} -a [gpu:${gpuIndex}]/GPUMemoryTransferRateOffset[2]=${value}`,
