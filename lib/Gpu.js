...
const GpuOverclock = function (display = ":0") {
  ...
  return {
    fan: function (gpuIndex, fanIndex, speed) {
      commands.push({
        message: `GPU ${gpuIndex + "".cyan} set fan speed ${speed + "".cyan}`,
        execute:
    ...
    power: function (gpuIndex, value) {
      commands.push({
        message: `GPU ${gpuIndex + "".cyan} Set power limit ${value + "".cyan}`,
    ...
    lockGraphicsClock: function (gpuIndex, value) {
      commands.push({
        message: `GPU ${gpuIndex + "".cyan} set lock graphics clock ${value + "".cyan}`,
    ...
    core: function (gpuIndex, value) {
      commands.push({
        message: `GPU ${gpuIndex + "".cyan} set graphics clock offset ${value + "".cyan}`,
    ...
    memory: function (gpuIndex, value) {
      commands.push({
        message: `GPU ${gpuIndex + "".cyan} set memory transfer rate offset ${value + "".cyan}`,
