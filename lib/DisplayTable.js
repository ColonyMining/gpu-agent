...
const PROFILES_STRUCTURE =
  "name:Profile{color:yellow},gpus:GPU[name:Name{color:cyan},settings:Settings[power:Power,fan:Fan,core:Core,memory:Memory,lgc:LGC,lmc:LMC,hashrate:HR{color:green}]]";
...
module.exports = { displayGpuStatusTable, displayGpuChangelog, displayProfiles, copyright };
