...
const PROFILES_STRUCTURE =
  "name:Profile{color:yellow},gpus:GPU[name:Name{width:16;color:cyan},tag:Tag{color:cyan},power:Power,fan:Fan,core:Core,memory:Mem," +
  "lgc:LGC,lmc:LMC,hashrate:HR{color:green}]";

const OVERCLOCK_STRUCTURE =
  "index:GPU,name:Name{color:cyan;width:16},tag:Tag{color:cyan},profile:Profile{color:yellow},settings:Settings" +
