...
const OVERCLOCK_STRUCTURE =
  "index:GPU,name:Name{color:cyan;width:16},power:Power[current:Current,config:Config]," +
  "fan:Fan[current:Current,config:Config],core:Core[current:Current,config:Config],memory:Mem[current:Current,config:Config]," +
  "lgc:LGC[current:Current,config:Config],lmc:LMC[current:Current,config:Config]";
