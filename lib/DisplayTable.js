...
const OVERCLOCK_STRUCTURE =
  "index:GPU,name:Name{color:cyan;width:16}," +
  "power:Power[current:Cur,config:Cfg{color:blue}],fan:Fan[current:Cur,config:Cfg{color:blue}]," +
  "core:Core[current:Cur,config:Cfg{color:blue}],memory:Mem[current:Cur,config:Cfg{color:blue}]," +
  "lgc:LGC[current:Cur,config:Cfg{color:blue}],lmc:LMC[current:Cur,config:Cfg{color:blue}]";
